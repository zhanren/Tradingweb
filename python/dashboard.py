...
####get all needed data###
orders = pd.read_csv('account_detail/historical_order.csv')
pl_history = pd.read_csv('account_detail/historical_order.csv')
trading_tickers = get_history_stock_ticker(orders)
today = datetime.datetime.today()
yield_rate_df = pd.read_csv('account_detail/yield_rate.csv')
current_holding = pd.read_csv('account_detail/current_holding.csv')
